              ...
              {status === 'connected' && appInfo ? (
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[13px] font-medium">{appInfo.name}</span>
                    <span className="text-[11px] opacity-40 ml-auto">{appInfo.tools.length} tool{appInfo.tools.length !== 1 ? 's' : ''}</span>
                  </div>
                  <p className="text-[11px] text-[var(--color-text-muted)]">{devUrl}</p>
